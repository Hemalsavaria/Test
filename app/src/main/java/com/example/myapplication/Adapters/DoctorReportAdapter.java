...
public class DoctorReportAdapter extends RecyclerView.Adapter<DoctorReportAdapter.ViewHolder> {
    ArrayList<DoctorReportModel> doctorReport;
    DoctorReportModel model;
    boolean open_details = false;

    public DoctorReportAdapter(ArrayList<DoctorReportModel> doctorReport) {
