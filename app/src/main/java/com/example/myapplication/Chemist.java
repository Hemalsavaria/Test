...
import com.example.myapplication.Adapters.ChemistAdapter;
...
public class Chemist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Chemist.this));
    ...
    void get_allChemist() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(Chemist.this);
    ...
    private void open_dialog() {
        ...
        dialog_new_doctor = new Dialog(Chemist.this, R.style.MyAlertDialogStyle);
        dialog_new_doctor.setContentView(R.layout.dialog_add_chemist);
        ...
        birth_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datepicker = new DatePickerDialog(Chemist.this,
...
//                    Email.setError("Enter Valid Email");
                //      }
                    ...
                    Toast.makeText(Chemist.this, "Select Area", Toast.LENGTH_SHORT).show();
                } else if (sp_city.getSelectedItemPosition() == 0) {
                    Toast.makeText(Chemist.this, "Select City", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void add_new_doctor(String name, String contact, String email, String medical_name, String area, String city, String bithdate, String anny, String practice) {
        ...
        Call<Result> call = apiServices.add_Chemist(name, contact, email, medical_name, bithdate, anny, practice, area, city);
